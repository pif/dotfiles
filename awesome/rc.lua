...
beautiful.init("/home/pif/.config/awesome/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "rxvt-unicode" -- x-terminal-emulator"
...
tags = {
  names  = { "term", "www", "skype", "dev", "hlam" },
  layout = { layouts[4], layouts[10], layouts[7], layouts[6], layouts[2]
 }}
...
vicious.register(mynetwidget, vicious.widgets.net, '<span color="#CC9393">${eth0 down_kb}</span> <span color="#7F9F7F">${eth0 up_kb}</span>', 3)
...
-- Initialize widget
textmemwidget = widget({ type = "textbox" })
vicious.register(textmemwidget, vicious.widgets.mem, "<span color=\"white\">$2MB</span>/$3MB", 13)
...
-- vicious.register(oswidget, vicious.widgets.os, "$1 $2 $3 $4 $5 $6 !!!")
...
-- vicious.register(datewidget, vicious.widgets.date, "%a, %d-%m-%Y %R", 60)

-- Create a textclock widget
mytextclock = awful.widget.textclock({ align = "right" }, "%R %A, %d-%m-%Y")
